...
_C.MODEL_TYPE = {"TYPE": 'YOLOv4'}  #YOLO type:YOLOv4, Mobilenet-YOLOv4 or Mobilenetv3-YOLOv4

_C.CONV_TYPE = {"TYPE": 'DO_CONV'}  #conv type:DO_CONV or GENERAL

_C.ATTENTION = {"TYPE": 'NONE'}  #attention type:SEnet、CBAM or NONE

# train
_C.TRAIN = CN()

_C.TRAIN.DATA_TYPE = 'Customer',  #DATA_TYPE: VOC ,COCO or Customer
_C.TRAIN.TRAIN_IMG_SIZE = 416,
